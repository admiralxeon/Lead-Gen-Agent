...
SENDER_NAME = "Sanjit"
SENDER_ROLE = "CEO & Founder"

# --- Competitor exclusion ---
# Known competitors are excluded deterministically, BEFORE any LLM call is
# made - never trust the model's own judgment on "is this a competitor,"
# same principle as the tier-derivation fix in schemas.py (don't trust a
# self-reported field when the correct value can be computed in code).
# Bare domain only, no "https://" or "www." prefix.
COMPETITOR_DOMAINS = [
    "wolfx.io",
